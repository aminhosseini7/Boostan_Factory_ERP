...
export const saleStatusLabel={ACTIVE:'فعال',PARTIAL_RETURN:'مرجوعی بخشی',PARTIALLY_RETURNED:'مرجوعی بخشی',RETURNED:'مرجوع‌شده',CANCELLED:'باطل‌شده'};
export const shiftStatusLabel={ACTIVE:'در حال انجام',AWAITING_NEXT_COUNTER:'در انتظار کانتر شروع شیفت بعد',AWAITING_DEFECTS:'منتظر ثبت معیوب',FINALIZED:'نهایی‌شده'};
...
export const activityLabel={LOGIN:'ورود به سامانه',CREATE_PRODUCT:'ثبت محصول',UPDATE_PRODUCT:'ویرایش محصول',CREATE_CUSTOMER:'ثبت مشتری',CREATE_SALE:'ثبت فروش',CANCEL_SALE:'ابطال فروش',RETURN_SALE:'مرجوعی فروش',CREATE_PAYMENT:'وصول مطالبات',CREATE_PURCHASE:'ثبت خرید',CREATE_GRINDING:'ثبت آسیاب',CREATE_EXPENSE:'ثبت هزینه',START_SHIFT:'ثبت کانتر شروع',END_SHIFT:'ثبت تعداد معیوب',SET_INVENTORY:'اصلاح موجودی'};
